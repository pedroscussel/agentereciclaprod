...
class ContaReceberAdminList extends TPage
{
    private $form; // form
    ...
    public function __construct($param = null)
    {
        ...
        $action_onDelete = new TDataGridAction(array('ContaReceberAdminList', 'onDelete'));
        ...
        $action_onQuitarConta = new TDataGridAction(array('ContaReceberAdminList', 'onQuitarConta'));
        ...
        $action_onQuitarConta->setDisplayCondition('ContaReceberAdminList::onShowQuitar');
