...
class ContaPagarAdminList extends TPage
{
    private $form; // form
    ...
    public function __construct($param = null)
    {
        ...
        $row2 = $this->form->addFields([new TLabel("Cliente:", null, '14px', null)],[$cliente_id],[new TLabel("Quitada:", null, '14px', null)],[$quitada]);
        ...
        $row5 = $this->form->addFields([new TLabel("Empresa:", null, '14px', null)],[$system_unit_id],[],[]);
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['ContaPagarForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $action_onDelete = new TDataGridAction(array('ContaPagarAdminList', 'onDelete'));
        ...
        $action_onQuitarConta = new TDataGridAction(array('ContaPagarAdminList', 'onQuitarConta'));
        ...
        $action_onQuitarConta->setDisplayCondition('ContaPagarAdminList::onShowQuitar');
