...
class ContaPagarMesAdminChart extends TPage
{
    private $form; // form
    private $loaded;
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Gráfico de contas a pagar por mês");
        ...
        $natureza_id = new TDBSelect('natureza_id', 'mini_erp', 'Natureza', 'id', '{nome}','nome asc' , $criteria_natureza_id );
        ...
        $row1 = $this->form->addFields([new TLabel("Cliente:", null, '14px', null)],[$cliente_id],[new TLabel("Quitada:", null, '14px', null)],[$quitada]);
        ...
        $row4 = $this->form->addFields([new TLabel("Natureza:", null, '14px', null)],[$natureza_id],[new TLabel("Empresa:", null, '14px', null)],[$system_unit_id]);
