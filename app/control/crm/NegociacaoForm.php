...
class NegociacaoForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $criteria_tipo_negociacao_id = new TCriteria();
        ...
        $criteria_negociacao_produto_negociacao_produto_id = new TCriteria();
        ...
        $tipo_negociacao_id = new TDBCombo('tipo_negociacao_id', 'mini_erp', 'TipoNegociacao', 'id', '{nome}','nome asc' , $criteria_tipo_negociacao_id );
        ...
        $obs = new TText('obs');
        $negociacao_produto_negociacao_produto_id = new TDBCombo('negociacao_produto_negociacao_produto_id', 'mini_erp', 'Produto', 'id', '{nome}','id asc' , $criteria_negociacao_produto_negociacao_produto_id );
        ...
        { 
            ...
            foreach ($items as $key => $item) 
            {
                ...
                if(isset($item['negociacao_produto_negociacao_produto_id']) && $item['negociacao_produto_negociacao_produto_id'])
                {
                    ...
                    if($produto)
                    {
                        $rowItem->negociacao_produto_negociacao_produto_id = $produto->render('{nome}');
                    }
                    TTransaction::close();
                }
