...
class NegociacaoAdminList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $column_system_unit_name = new TDataGridColumn('system_unit->name', "Empresa", 'left');
        ...
        $column_dt_inicio_negociacao_transformed->setTransformer(function($value, $object, $row, $cell = null, $last_row = null)
        {
            if(!empty(trim($value)))
            {
                try
        ...
        $column_dt_fim_negociacao_transformed->setTransformer(function($value, $object, $row, $cell = null, $last_row = null)
        {
            if(!empty(trim($value)))
            {
                try
