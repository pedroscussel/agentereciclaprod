...
class OrcamentoAdminList extends TPage
{
    private $form; // form
    ...
    public function __construct($param = null)
    {
        ...
        $column_dt_orcamento_transformed->setTransformer(function($value, $object, $row, $cell = null, $last_row = null)
        {
            if(!empty(trim($value)))
            {
                try
        ...
        $action_onDelete = new TDataGridAction(array('OrcamentoAdminList', 'onDelete'));
