...
class CidadeList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $estado_id = new TDBCombo('estado_id', 'mini_erp', 'Estado', 'id', '{nome}','nome asc' , $criteria_estado_id );
        ...
        $row2 = $this->form->addFields([new TLabel("Nome:", null, '14px', null)],[$nome],[new TLabel("Estado", null, '14px', null)],[$estado_id]);
