...
class VendaAdminList extends TPage
{
    private $form; // form
    ...
    public function __construct($param = null)
    {
        ...
        $row4 = $this->form->addFields([new TLabel("Empresa:", null, '14px', null)],[$system_unit_id],[],[]);
        ...
        $action_onDelete = new TDataGridAction(array('VendaAdminList', 'onDelete'));
        ...
        $action_onCancelarVenda = new TDataGridAction(array('VendaAdminList', 'onCancelarVenda'));
        ...
        $action_onCancelarVenda->setDisplayCondition('VendaAdminList::onShowCancelarVenda');

        $action_group->addAction($action_onCancelarVenda);

        $action_onFecharVenda = new TDataGridAction(array('VendaAdminList', 'onFecharVenda'));
        ...
        $action_onFecharVenda->setDisplayCondition('VendaAdminList::onShowFecharVenda');
