...
class NegociacaoAdminReport extends TPage
{
    private $form; // form
    private $loaded;
    ...
    public function __construct()
    {
        ...
        $row1 = $this->form->addFields([new TLabel("Empresa:", null, '14px', null)],[$system_unit_id],[new TLabel("Tipo da negociação:", null, '14px', null)],[$tipo_negociacao_id]);
                ...
                if (!empty($tr))
                {
                    ...
                    foreach ($objects as $object)
                    {
                        ...
                        if ($object->system_unit_id !== $breakValue)
                        {
                            ...
                            $tr->addRow();
                            $tr->addCell($object->render('{system_unit->name}'), 'left', 'break', 8);
                            $breakTotal = [];
                        }
