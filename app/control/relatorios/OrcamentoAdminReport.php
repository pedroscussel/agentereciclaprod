...
class OrcamentoAdminReport extends TPage
{
    private $form; // form
    private $loaded;
    ...
    public function __construct()
    {
        ...
        $row1 = $this->form->addFields([new TLabel("Id:", null, '14px', null)],[$system_unit_id],[new TLabel("Estado do orçamento:", null, '14px', null)],[$estado_orcamento_id]);
    ...
    public function onGenerate($format)
    {
        try
        {
            ...
            $param['order'] = 'system_unit_id,dt_orcamento';
