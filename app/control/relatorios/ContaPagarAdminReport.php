...
class ContaPagarAdminReport extends TPage
{
    private $form; // form
    private $loaded;
    ...
    public function __construct()
    {
        ...
        $row4 = $this->form->addFields([new TLabel("Quitada:", null, '14px', null)],[$quitada],[new TLabel("Empresa:", null, '14px', null)],[$system_unit_id]);
    ...
    public function onGenerate($format)
    {
        try
        {
            ...
            $param['order'] = 'system_unit_id,dt_vencimento';
